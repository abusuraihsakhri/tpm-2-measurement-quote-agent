"""
FastAPI REST API Server for Tpm 2 Measurement Quote Agent.
"""
...
app = FastAPI(
    title="Tpm 2 Measurement Quote Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "tpm-2-measurement-quote-agent", "domain": "Post-Quantum Cryptography & Hardware Security", "standard": "NIST FIPS 203/204/205 / ISO/IEC 17825 Standards", "version": "3.0.0-ENTERPRISE"}
