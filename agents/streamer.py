"""
Live WebSocket Distributed Component Telemetry Streamer for tpm-2-measurement-quote-agent.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "tpm-2-measurement-quote-agent", "event_type": event_type, "payload": data})
